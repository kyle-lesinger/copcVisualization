...
var __exports__ = (() => {
  ...
  var PotreeNodesSource = class extends DataSource {
     ...
     */
    async loadHierarchy() {
      this.root = await (0, import_core.load)(
